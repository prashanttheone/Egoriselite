...
const features = [
  ...
  },
  {
    ...
    description: 'Our team of experts provides exceptional customer service and support.',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 mb-8">
              We are a leading supplier of high-quality products, committed to
              providing exceptional service and value to our customers worldwide.
